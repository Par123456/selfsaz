...
DBName = "localhost" # اسم دیتابیس اصلی
DBUser = "localhost" # یوزرنیم دیتابیس اصلی
DBPass = "localhost" # پسورد دیتابیس اصلی
HelperDBName = "localhost" # اسم دیتابیس هلپر
HelperDBUser = "localhost" # یوزرنیم دیتابیس هلپر
HelperDBPass = "localhost" # پسورد دیتابیس هلپر
