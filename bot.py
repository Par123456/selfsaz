...
DBName = "a1176921_no1" # اسم دیتابیس اصلی
DBUser = "a1176921_no1" # یوزرنیم دیتابیس اصلی
DBPass = "xTJJnO04" # پسورد دیتابیس اصلی
HelperDBName = "a1176921_no1" # اسم دیتابیس هلپر
HelperDBUser = "a1176921_no1" # یوزرنیم دیتابیس هلپر
