...
async def call(app, call):
          ...
          [
               [
                    InlineKeyboardButton('سراسری - شخصی',callback_data=f'global_person1-{call.from_user.id}')
                              ...
                              [
                    InlineKeyboardButton('سرگرمشو',callback_data=f'global_person3-{call.from_user.id}'),
                    InlineKeyboardButton('راهنما وپنل',callback_data=f'global_person4-{call.from_user.id}')
               ],
               
                                             [
                    InlineKeyboardButton('بخش کامنتر',callback_data=f'profile16-{call.from_user.id}'),
                    InlineKeyboardButton('بخش مدیریت',callback_data=f'profile17-{call.from_user.id}')
               ],
               [
                    InlineKeyboardButton('پروفایل',callback_data=f'profile1-{call.from_user.id}'),
                    InlineKeyboardButton('بخش پین و سکوت',callback_data=f'downloader2-{call.from_user.id}')   
               ],
               [
     ...
     if call.data != "outside":
          if AdminUser is not None and int(call.from_user.id) == int(call.data.split("-")[1]):
	          ...
	          if call.data.split("-")[0] == "persian":
	          ...
	          elif call.data.split("-")[0] == "global_person3":
	               await app.edit_inline_text(inline_message_id=call.inline_message_id, text=saeed1, reply_markup=dast1)
	               
	          elif call.data.split("-")[0] == "global_person4":
	               await app.edit_inline_text(inline_message_id=call.inline_message_id, text=saeed2, reply_markup=dast1)
	          ...
	          elif call.data.split("-")[0] == "profile16":
	               await app.edit_inline_text(inline_message_id=call.inline_message_id, text=saeed5, reply_markup=dast1)

	          elif call.data.split("-")[0] == "profile17":
	               await app.edit_inline_text(inline_message_id=call.inline_message_id, text=saeed6, reply_markup=dast1)
	               ...
	               await app.edit_inline_text(inline_message_id=call.inline_message_id, text=saeed16, reply_markup=dast1)
